...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.morqan.voiceink.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.morqan.voiceink", category: "SoundPlaybackEngine")
