...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.morqan.voiceink", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "com.morqan.voiceink.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "com.morqan.voiceink.audioSetup", qos: .userInitiated)
