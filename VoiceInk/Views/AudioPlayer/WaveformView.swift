...
//  VoiceInk
//
//  The interactive waveform strip for AudioPlayerView: draws the bars, the hover
//  time tooltip and the scrub line, and reports seeks via `onSeek`.
//
        ...
        GeometryReader { geometry in
            ZStack(alignment: .leading) {
                if isLoading {
                    ...
                    if isHovering {
                        Text((duration * Double(hoverLocation / geometry.size.width)).formattedClock())
